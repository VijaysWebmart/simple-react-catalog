...
const ContactPage = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    const whatsappMessage = `Hi! I'm ${formData.name}. Subject: ${formData.subject}. Message: ${formData.message}. Email: ${formData.email}`;
    const whatsappUrl = `https://wa.me/919168585280?text=${encodeURIComponent(whatsappMessage)}`;
            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">+91 9168585280</p>
